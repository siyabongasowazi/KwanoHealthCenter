<%@ Page Title="" Language="C#" MasterPageFile="~/NurseIndex.Master" AutoEventWireup="true" CodeBehind="DefaultNurse.aspx.cs" Inherits="KwanoHealthCenter.DefaultNurse" %>
     ...
     <header>
        <div id="nav" style="background-color:#3badf5; height: 95px; background-color: #3badf5; height: 175px; width: 100%; background-size: cover; background-repeat: no-repeat; background-position: 50% 50%;" class="transNav">
         <div class="text-center">
                                ...
                                <h2 style="color:white; margin-top: 15px;">Nurse Home</h2>
                                <br/>
         </div>
     </div>
    </header>
