...
namespace DataAccessLayer
{
    public class MainMember
    {
        ...
        public MainMember(string name, string surname, string IDNo, string CellNo, string emailAddress, string isMedicalAid, int medicalAidPlanID, string medicalNo, string AddressL1, string AddressL2, int suburbID, string personResponsible)
        {
            this.FirstName = name;
